...
local plist = require "Net/GameLogic/Pbc/protolist"
...
local function readfile(path, name)
	...
	local f = UE4.FFileHelper.LoadContentFileAllBytesForLua(fullname)
